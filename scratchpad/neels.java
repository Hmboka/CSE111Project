...
public class test2 {
    ...
    private int personal2() { //to make this function more usable you can take in a decider string which decides how this functio
        ...
        if (bookIDCount(bookID) == 0){
            System.out.print("Sorry, book ID '" + bookID + "' does not exist. Please try again.");
            personal2();
        }
    ...
    private int personal4() {
        System.out.println("Do you know the bookID for the book you'd like to add? Enter 'Yes' or 'No'");
        myScanner.nextLine();
        ...
        if(answer == "YES"){
            System.out.println("Okay lets search the GooodReads database ");
        }
